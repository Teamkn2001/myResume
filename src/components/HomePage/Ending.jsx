            ...
            {isMobile
                ...
                : <div className='relative bg-red-400 '>
                    ...
                    <div className='absolute z-50 top-1/3 -translate-y-1/2 left-1/2 -translate-x-1/2 text-white flex flex-col items-center gap-5'>
                        <div className='text-3xl font-bold shadow-lg'><CopyText text="Sudtipong.fullstack@gmail.com" /></div>
                        <div className='text-3xl font-bold shadow-lg'> <CopyText text="https://github.com/Teamkn2001" /></div>
                        <div className='text-3xl font-bold shadow-lg'>LineId :  <CopyText text="Xzia1412" /></div>
                    </div>
                </div>
            }
        </>
